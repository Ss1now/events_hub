        ...
        <div className='flex flex-col bg-white border-r border-gray-200 shadow-sm w-64'>
            ...
            <nav className='flex-1 px-4 py-6'>
                <div className='space-y-1'>
                    ...
                    <Link href='/admin/assigntag' className='flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors group'>
                        <svg className='w-5 h-5 text-gray-500 group-hover:text-gray-700' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                            <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z' />
                        </svg>
                        <span className='text-sm'>🏷️ Assign Event Tags</span>
                    </Link>
