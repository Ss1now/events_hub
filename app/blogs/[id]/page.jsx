                    ...
                    <div className='flex justify-between items-start mb-4 md:mb-6'>
                        <div className='flex-1'>
                            ...
                            <div className='flex items-center gap-3'>
                                ...
                                {data.authorId?.instagram && (
                                    <a 
                                        href={`https://instagram.com/${data.authorId.instagram}`}
                                        target='_blank'
                                    ...
                                    >
                                        ...
                                        <span className='text-xs font-medium text-pink-300 group-hover:text-pink-200'>@{data.authorId.instagram}</span>
                                    </a>
                                )}
                            </div>
                        </div>
